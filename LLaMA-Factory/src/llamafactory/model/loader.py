...
def load_model(
    ...
    allow_torch29_conv3d = os.getenv("LLAMAFACTORY_ALLOW_TORCH29_CONV3D", "0") == "1"
    if (
        is_torch_version_greater_than("2.9.0")
        and not is_torch_version_greater_than("2.10.0")
        and not allow_torch29_conv3d
    ):
