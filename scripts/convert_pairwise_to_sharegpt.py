#!/usr/bin/env python3
"""
Convert pairwise dataset to LLaMA-Factory sharegpt format for Qwen3-VL training.

The pairwise dataset has entries like:
{
    "1": {
        "question": "...",
        "image": "...",
        "A": "<think>...</think>The answer is...",
        "B": "<think>...</think>The answer is...",
        "correct_answer": "A" or "B"
    },
    ...
}

We convert this to sharegpt format for VLM training:
[
    {
        "messages": [
...
if __name__ == "__main__":
    input_file = "/path/to/Medthink/Medthink_Dataset/Merged_Dataset/Pairwise_Dataset/Final_Merged/train_all_pairwise_with_ab.json"
    output_file = "/path/to/Medthink/Medthink_Dataset/Merged_Dataset/Pairwise_Dataset/Final_Merged/train_pairwise_sharegpt.json"
